    ...
    for i = 1:length(time_step)
        %% Interpolation of variables en niveles Z
            ...
            for j = 1:length(ZI)
                ...
                save([subdir,num2str(2001),'_',num2str(month),'_','t' num2str(i) '.txt'],'tempr','-ascii');
                save([subdir,num2str(2001),'_',num2str(month),'_','c' num2str(i) '.txt'],'DCHLr','-ascii');
                ...
                save([subdir,num2str(2001),'_',num2str(month),'_','z' num2str(i) '.txt'],'zr','-ascii');
                save([subdir,num2str(2001),'_',num2str(month),'_','m' num2str(i) '.txt'],'mr','-ascii');
            end
   end    
end
%%%%%% %%%%%% %%%%%% %%%%%%   END OF PROGRAM  %%%%%% %%%%%% %%%%%% %%%%%%
