...
dirpath <- '/run/media/cimobp/JORGE_OLD/ROMS_SIMULATIONS/ROMS6B_VINCENT_SIMULATION/vieja/' # To store new mask
nc_file <- '/run/media/cimobp/JORGE_OLD/ROMS_SIMULATIONS/ROMS6B_VINCENT_SIMULATION/roms6b_avg.Y2008.M1.rl1b.nc' # Name of any-ROMS file
