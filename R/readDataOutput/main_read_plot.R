...
dens2D_map_byage(df = df, outpath = outpathFigures, ages = stepToPlot, xlimmap = c(-85,-70), ylimmap = c(-20,0), alive = T)

dens2D_map_byday(df = df, outpath = outpathFigures, days = stepToPlot)
dens2D_map_byday(df = df, outpath = outpathFigures, days = stepToPlot, xlimmap = c(-85,-70), ylimmap = c(-20,0), alive = T)

#--- Plot Knob Map ---#
knob_map_byage(df = df, outpath = outpathFigures, ages = c(stepToPlot))
knob_map_byage(df = df, outpath = outpathFigures, ages = c(stepToPlot), xlimmap = c(-85,-70), ylimmap = c(-20,0), alive = T)

knob_map_byday(df = df, outpath = outpathFigures, days = c(stepToPlot))
knob_map_byday(df = df, outpath = outpathFigures, days = c(stepToPlot), xlimmap = c(-85,-70), ylimmap = c(-20,0), alive = T)

# Plot Weight Map ---#
weight_map_byage(df = df, outpath = outpathFigures, ages = c(stepToPlot), zlimmap = c(0,23))
weight_map_byage(df = df, outpath = outpathFigures, ages = c(stepToPlot), xlimmap = c(-85,-70), ylimmap = c(-20,0), alive = T, zlimmap = c(0,23))

weight_map_byday(df = df, outpath = outpathFigures, days = c(stepToPlot), zlimmap = c(0,23))
weight_map_byday(df = df, outpath = outpathFigures, days = c(stepToPlot), xlimmap = c(-85,-70), ylimmap = c(-20,0), alive = T, zlimmap = c(0,23))
